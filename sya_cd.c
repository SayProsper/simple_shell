...
/**
 * sya_dot - changes to the parent directory
 *
 * @datash: data relevant (environ)
 *
 * Return: no return
 */
void sya_dot(data_shell *datash)
{
	char pwd[PATH_MAX];
...
/**
 * sya_to - changes to a directory given
 * by the user
 *
 * @datash: data relevant (directories)
 * Return: no return
 */
void sya_to(data_shell *datash)
{
	char pwd[PATH_MAX];
...
/**
 * sya_previous - changes to the previous directory
 *
 * @datash: data relevant (environ)
 * Return: no return
 */
void sya_previous(data_shell *datash)
{
	char pwd[PATH_MAX];
...
/**
 * sya_to_home - changes to home directory
 *
 * @datash: data relevant (environ)
 * Return: no return
 */
void sya_to_home(data_shell *datash)
{
	char *p_pwd, *home;
	char pwd[PATH_MAX];
